...
- (void)erase {
    ...
    [self.signatureViewDelegate signatureView:self didFinishEditingWithImage:nil];
...
- (void)pan:(UIPanGestureRecognizer *)p {
    ...
    if ([p state] == UIGestureRecognizerStateBegan) {
        ...
        [self.signatureViewDelegate signatureView:self didFinishEditingWithImage:self.signatureImage];
    }
